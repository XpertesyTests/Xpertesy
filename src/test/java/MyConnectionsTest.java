...
public class MyConnectionsTest extends UseCaseBase {
    ...
    private static MyConnectionPage myConnectionPage;
    ...
    public static void classSetup() {
        ...
        myConnectionPage = new MyConnectionPage();
    }
    ...
    public void inviteNewConnectionTest() throws Exception {
        ...
        myConnectionPage.clickOnInviteButton();
        Boolean isVisible = myConnectionPage.isSuccessTextVisible();
        assertTrue(isVisible);
        myConnectionPage.takeScreenshot("InvitingLink");
    }
